              ...
              {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                ...
                <View style={styles.tabContainer}>
                  <TouchableOpacity onPress={()=>setActiveTab(0)} style={[styles.tab,{backgroundColor:activeTab === 0 ? theme.colors.primary : '#fff'}]}>
                    <Text style={ {color:activeTab === 0 ? '#222' : theme.colors.primary} }>Edit List</Text>
                  </TouchableOpacity>
                  <TouchableOpacity  onPress={()=>{
                    navigation.navigate('UploadImage',{id:list.id});
                    setActiveTab(1)}
                    } style={[styles.tab,{backgroundColor:activeTab === 1 ? theme.colors.primary : '#fff'}]}>
                    <Text style={ {color:activeTab === 1 ? '#222' : theme.colors.primary} }>Add images</Text>
                  </TouchableOpacity>
                </View>
